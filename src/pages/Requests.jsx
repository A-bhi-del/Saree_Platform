...
function Requests() {
  ...
  if (loading) {
    return (
      <div
        className={`flex justify-center items-center min-h-[60vh] ${isDark ? "bg-slate-950 text-slate-300" : "bg-gray-50 text-gray-700"}`}
      >
  ...
  if (error) {
    return (
      <div
        className={`flex justify-center items-center min-h-[60vh] ${isDark ? "bg-slate-950 text-red-400" : "bg-gray-50 text-red-600"}`}
      >
      ...
      <div className="grid grid-cols-1 gap-6">
        {requests.map((request) => (
          ...
          >
            ...
            <div
              className={`w-full md:w-44 h-56 md:h-44 rounded-lg overflow-hidden flex-shrink-0 border ${
                isDark
            ...
            <div className="flex-grow space-y-4 w-full">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <h3
                  className={`text-lg font-bold font-serif ${isDark ? "text-slate-200" : "text-gray-800"}`}
                >
                  {request.designName}
                </h3>
              ...
              >
                <div>
                  <span
                    className={`block text-[11px] font-semibold uppercase tracking-wider ${isDark ? "text-slate-500" : "text-gray-400"}`}
                  >
                    Fabric
                  </span>
                  <span
                    className={`font-medium capitalize ${isDark ? "text-slate-300" : "text-gray-700"}`}
                  >
                    {request.fabric}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span
                    className={`font-bold ${isDark ? "text-slate-200" : "text-gray-800"}`}
                  >
                ...
                <div>
                  ...
                  <span
                    className={`font-bold ${isDark ? "text-rose-400" : "text-rose-900"}`}
                  >
                    ₹{request.budget}
                  </span>
                </div>
              ...
              <div className="space-y-1.5">
                ...
                >
                  <span
                    className={`font-semibold not-italic block mb-0.5 ${isDark ? "text-slate-300" : "text-gray-600"}`}
                  >
                    Notes:
                  </span>
                  "
                  {request.description ||
                    "No specific instructions added by the user."}
                  "
                </p>
                <div
                  className={`text-xs flex items-center gap-1 pt-1 ${isDark ? "text-slate-400" : "text-gray-500"}`}
                >
