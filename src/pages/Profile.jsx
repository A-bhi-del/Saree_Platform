...
function Profile() {
  ...
  return (
    ...
    >
      <div
        className={`max-w-2xl mx-auto rounded-2xl p-6 md:p-8 shadow-xl border ${theme === "dark" ? "bg-slate-800 border-slate-700" : "bg-white border-gray-100"}`}
      >
        {/* Header Section */}
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          {user.role === "admin" && (
            <div
              className={`p-4 rounded-xl border col-span-1 md:col-span-2 ${theme === "dark" ? "bg-slate-800/50 border-amber-500/30" : "bg-amber-50/50 border-amber-200"}`}
            >
          ...
          <div
            className={`p-4 rounded-xl border ${theme === "dark" ? "bg-slate-800/40 border-slate-700" : "bg-gray-50 border-gray-100"}`}
          >
