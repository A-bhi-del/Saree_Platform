...
function EditSaree() {
  ...
  if (!saree) {
    return (
      <div
        className={`flex flex-col items-center justify-center min-h-screen font-serif transition-colors duration-300 ${
  ...
  function handleSubmit(e) {
    ...
    const updatedPayload = {
      ...
      name: name.trim(),
      fabric: fabric.trim(),
      category: category.trim() || saree.category || "General",
      price: Number(price),
      stock: Number(stock),
      color: color.trim(),
  ...
  return (
    ...
    >
      <div
        className={`max-w-3xl mx-auto rounded-2xl shadow-sm border p-6 md:p-10 transition-colors ${
