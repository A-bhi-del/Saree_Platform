...
function RoleSelection() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-md rounded-2xl border p-8 md:p-10 relative overflow-hidden transition-all duration-300 ${
          isDark
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1
            className={`text-3xl font-bold font-serif uppercase tracking-widest ${
          ...
          <p
            className={`text-xs font-medium uppercase tracking-wider mt-1 ${isDark ? "text-slate-500" : "text-gray-400"}`}
          >
        ...
        <div className="text-center mb-8">
          <h2
            className={`text-lg font-semibold font-serif ${isDark ? "text-slate-200" : "text-gray-800"}`}
          >
            Welcome Back Portal
          </h2>
          <p
        ...
        {/* Minimalist Footer */}
        <div
          className={`mt-8 pt-5 border-t text-center text-[11px] ${
            isDark
              ? "border-slate-800 text-slate-500"
              : "border-gray-100 text-gray-400"
          }`}
        >
          Secure Store Operations &copy; {new Date().getFullYear()} ZariSaree
          Inc.
        </div>
      </div>
    </div>
