...
function AdminDashboard() {
  ...
  if (sarees.length === 0) {
    return (
      ...
      >
        ...
        <h2
          className={`text-xl font-semibold ${theme === "dark" ? "text-slate-200" : "text-gray-700"}`}
        >
          Inventory is Completely Empty
        </h2>
        <p
          className={`text-sm mt-1 ${theme === "dark" ? "text-slate-500" : "text-gray-400"}`}
        >
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`mb-10 border-b pb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 ${
      ...
      >
        <div>
          ...
          >
            Real-time boutique metrics, batch health monitoring, and stock
            alerts.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
        <div
          className={`p-6 rounded-xl border shadow-sm flex items-center justify-between transition-all ${
            theme === "dark"
        ...
        >
          <div>
            <span
              className={`text-xs font-bold uppercase tracking-wider block ${theme === "dark" ? "text-slate-500" : "text-gray-400"}`}
            >
              Total Unique Designs
            </span>
            <span
              className={`text-3xl font-extrabold mt-2 block ${theme === "dark" ? "text-slate-100" : "text-gray-800"}`}
            >
              {sarees.length}
            </span>
          </div>
          <div
            className={`text-2xl p-3 rounded-lg ${theme === "dark" ? "bg-slate-800" : "bg-gray-50"}`}
          >
            🏷️
          </div>
        </div>
        ...
        >
          <div>
            ...
            <span
              className={`text-3xl font-extrabold mt-2 block ${theme === "dark" ? "text-rose-400" : "text-rose-900"}`}
            >
              {TotalStock}
            </span>
          </div>
          <div
            className={`text-2xl p-3 rounded-lg ${theme === "dark" ? "bg-rose-950/40 text-rose-400" : "bg-rose-50 text-rose-900"}`}
          >
            📦
          </div>
        </div>
        ...
        <div
          className={`p-6 rounded-xl shadow-sm flex items-center justify-between border transition-all ${
            theme === "dark"
              ? LowStock > 0
                ? "bg-slate-900 border-red-900/50 border-l-4 border-l-red-500"
                : "bg-slate-900 border-slate-800"
              : LowStock > 0
      ...
      <div>
        <h2
          className={`text-xs font-bold uppercase tracking-wider mb-4 ${theme === "dark" ? "text-slate-500" : "text-gray-400"}`}
        >
          Quick Utilities
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div>
              <span
                className={`font-serif font-bold text-base block transition-colors ${
                  theme === "dark"
                    ? "text-slate-200 group-hover:text-rose-400"
                    : "text-gray-800 group-hover:text-rose-900"
                }`}
              >
                Add New Saree
              </span>
              <span
                className={`text-xs mt-1 block ${theme === "dark" ? "text-slate-400" : "text-gray-400"}`}
              >
                Upload fresh fabric images, details, and adjust inventories.
              </span>
            </div>
            <span
              className={`text-xs font-bold mt-4 inline-block group-hover:translate-x-1 transition-transform ${
            ...
            <div>
              <span
                className={`font-serif font-bold text-base block transition-colors ${
                  theme === "dark"
                    ? "text-slate-200 group-hover:text-rose-400"
                    : "text-gray-800 group-hover:text-rose-800"
                }`}
              >
                🎉 Create Sale Event
              </span>
          ...
          >
            <div>
              ...
              <span
                className={`text-xs mt-1 block ${theme === "dark" ? "text-slate-400" : "text-gray-400"}`}
              >
                Review user design submissions, approve tickets or reject
                orders.
              </span>
            </div>
            <span
          ...
          >
            <div>
              ...
              <span
                className={`text-xs mt-1 block ${theme === "dark" ? "text-slate-400" : "text-gray-400"}`}
              >
                See how the product grids and stock numbers render for users
                live.
              </span>
            </div>
            <span
