  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <p
          className={`text-xs uppercase tracking-widest mt-1 ${isDark ? "text-slate-400" : "text-gray-500"}`}
        >
        ...
        {favourites.map((favourite) => (
          ...
          >
            ...
            >
              ...
              {favourite.stock < 5 && (
                <span
                  className={`absolute top-3 left-3 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded shadow-sm border ${
                    isDark
            ...
            <div className="p-5 flex flex-col flex-grow">
              <div className="flex justify-between items-start mb-1 gap-2">
                <h3
                  className={`text-base font-semibold font-serif line-clamp-1 ${
              ...
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span
                  className={`text-xs font-medium capitalize ${isDark ? "text-slate-300" : "text-gray-600"}`}
                >
                  {favourite.color}
                </span>
              </div>
              ...
              <p
                className={`text-xs line-clamp-2 mb-4 flex-grow ${isDark ? "text-slate-400" : "text-gray-500"}`}
              >
                {favourite.description ||
                  "No specific details available for this handloom piece."}
              </p>
